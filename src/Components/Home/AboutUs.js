...
const AboutUs = () => {
    return (
        <div className='bg-[#fbf8f3] rounded-t-[100px] grid md:grid-cols-2 items-center md:gap-14 gap-10 py-10 md:px-20 px-5'>
            <div>
                <img className='rounded-tl-3xl rounded-br-3xl rounded-tr-[100px] rounded-bl-[100px]' src="/Images/Home/aboutusSection.jpg" alt="" />
            </div>
            <div>
                <h2 className='md:text-4xl text-2xl text-[#111111] font-semibold'>A b o u t _ U s</h2>
