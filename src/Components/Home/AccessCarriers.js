    ...
    return (
        <div className='md:px-20 px-5 py-10'>
            <div className='md:w-1/2 mx-auto text-center'>
                <h2 className='md:text-4xl text-2xl text-[#111111] font-semibold text-center leading-[1.3]'>Fast Carrier Access and <br />
            ...
            <div className='grid md:grid-cols-2 grid-cols-1 items-center md:gap-14 gap-10 mt-10'>
                <div className='bg-gradient-to-tl from-[#0f5867] rounded-2xl to-[#131313] text-white md:px-10 px-5 md:py-32 py-10 flex items-center gap-10'>
                    <div >
                        <h2 className='md:text-2xl text-xl  font-semibold'>Access to <span className='text-[#dcb66b]'>12+ Carriers</span></h2>
