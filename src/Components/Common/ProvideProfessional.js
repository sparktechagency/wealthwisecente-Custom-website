...
const ProvideProfessional = () => {
    return (
        <div className='md:px-20 px-5 py-10'>
            <h2 className='md:text-4xl text-2xl text-[#111111] mb-10 font-semibold text-center leading-[1.3]'>We Provide professional <br />
                Insurance Services</h2>
            <div className='grid md:grid-cols-2 lg:grid-cols-3 grid-cols-1 gap-6 md:gap-10'>
                {[...Array(6)].map((_, index) => (
                    <div className='border border-[#dcb66b] rounded-lg shadow-lg' >
                        <div className='flex items-center gap-5 my-3'>
                            ...
                            <h2 className='md:text-2xl text-xl text-[#111111] font-semibold'>Life Insurance</h2>
                        </div>
                        <div className='p-5'>
